...
import com.dermacon.workshop.controller.admin.SelectedElements;
...
import com.dermacon.workshop.data.ItemPreset;
import com.dermacon.workshop.data.ItemPresetRepository;
import com.dermacon.workshop.data.ItemRepository;
import com.dermacon.workshop.data.LivingSpace;
import com.dermacon.workshop.data.LivingSpaceRepository;
import com.dermacon.workshop.data.Room;
import com.dermacon.workshop.data.SupplyCategory;
import com.dermacon.workshop.data.TaskRepository;
...
public class GroceryListController {
    ...
    private Flatmate getLoggedInFlatmate() {
        AppUser currUser = getLoggedInUser();
    ...
    private AppUser getLoggedInUser() {
        ...
        String user_name = ((AppUser) SecurityContextHolder
                .getContext()
                .getAuthentication()
